...
export default function Home() {
    const features = [
        ...
        },
        {
            ...
            description: "Generate detailed diagram images with comments for your solution design documents"
        },
        {
    ...
    /**
     * Changelog entries that will be sorted by version number in descending order.
     * The changelogs are displayed in a scrollable area with the most recent version at the top.
     */
    const changelogs = [
        {
            version: "1.0.0",
                            ...
                            <div className="ml-4 relative border-l-2 border-border">
                                {changelogs.map((log, index) => (
                                    <div key={index} className="relative pl-8 pb-8 last:pb-0">
                                        <div
                                            className="absolute -left-[15px] top-0 bg-background p-1 rounded-full border-2 border-border">
                                            {log.type === 'feature' ? (
